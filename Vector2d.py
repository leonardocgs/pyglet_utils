...
class Vector2d:
    ...
    def distance(self, vector: "Vector2d") -> float:
        ...
        :type vector: "Vector2d"
        :return: Caso um Vector2d seja passado como argumento da função o valor
        retornado será a distância entre os Vector2des, caso contrário será retornado um valor False.
        :rtype: float
